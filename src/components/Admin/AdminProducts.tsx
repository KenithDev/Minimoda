  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16 py-4 sm:py-6 md:py-8 max-w-[1920px]">
      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-gray-800 mb-6 sm:mb-8 flex items-center gap-2 sm:gap-3">
        <Package className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 text-blue-600" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3.5 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3.5 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all resize-none"
                  rows={3}
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3.5 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-white"
                  required
                >
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-4 rounded-lg hover:bg-blue-700 transition-all font-bold shadow-md hover:shadow-lg transform active:scale-95 flex items-center justify-center gap-2"
              >
                {editingId ? (
                  <>
              ...
              {editingId && (
                <button
                  ...
                  className="w-full bg-gray-500 text-white py-4 rounded-lg hover:bg-gray-600 transition-all font-bold shadow-md"
                >
                  Cancelar
                </button>
              )}
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-gray-200">
            <div className="mb-6">
              ...
              <select
                ...
                className="px-5 py-3.5 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-white font-medium"
              >
              ...
              <table className="w-full">
                ...
                <tbody className="bg-white">
                  {productosFiltrados.map((producto, index) => (
                    <tr key={producto.idProducto} className={`border-b-2 border-gray-100 hover:bg-blue-50 transition-colors ${index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}`}>
                      ...
                      <td className="px-6 py-4 font-bold text-blue-600">${producto.precio}</td>
                      <td className="px-6 py-4">
