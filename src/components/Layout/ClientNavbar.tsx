        ...
        <div className="flex items-center justify-between h-16 sm:h-18 md:h-20 lg:h-22 xl:h-24">
          ...
          <a href="#/" className="flex items-center gap-2 sm:gap-3 md:gap-4 lg:gap-5 xl:gap-6 group">
            ...
            <div className="flex flex-col">
              <span className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-black tracking-tight text-gray-900 group-hover:text-blue-600 transition-colors">
                MINIMODA
              </span>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 lg:gap-4 xl:gap-5">
            ...
            <a 
              href="#/carrito" 
              className="relative px-3 py-2 sm:px-4 sm:py-2.5 md:px-6 md:py-3 lg:px-7 lg:py-3.5 xl:px-8 xl:py-4 rounded-lg hover:bg-blue-50 text-gray-700 hover:text-blue-600 transition-all duration-200 font-semibold flex items-center gap-1.5 sm:gap-2 md:gap-2.5 lg:gap-3 group border-2 border-transparent hover:border-blue-200"
            >
              <div className="relative">
