      ...
      <nav className="bg-white border-b-4 border-[#5A4633] shadow-lg sticky top-0 z-50">
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16 max-w-[1920px]">
          <div className="flex items-center justify-between h-16 sm:h-18 md:h-20 lg:h-22 xl:h-24">
            ...
            <a
              href="#/"
              className="flex items-center gap-2 sm:gap-3 md:gap-4 lg:gap-5 xl:gap-6 group"
            >
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 lg:gap-4 xl:gap-5">
              ...
              >
                ...
                <span className="hidden md:inline text-sm md:text-base lg:text-lg xl:text-xl">
                  Productos
                </span>
              </a>
              ...
              <button
                onClick={() =>
                  clientUser ? logoutClient() : setIsAuthModalOpen(true)
                }
              ...
              >
                {clientUser ? (
                  <>
                    ...
                    <span className="hidden md:inline text-sm md:text-base lg:text-lg xl:text-xl truncate max-w-[150px]">
                      {clientUser.name.split(" ")[0]}
                    </span>
                    <LogOut className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 ml-2" />
                  </>
                ) : (
                  <>
                    <User className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" />
